...
.vv-text-strikethrough { text-decoration: line-through; color: var(--vv-muted, #6b7280); }
...
.vv-text-code {
    ...
    background: var(--vv-code-bg, #222535);
    padding: 2px 6px;
    border-radius: 4px;
    font-size: 0.9em;
    color: var(--vv-text, #e2e4ed);
...
/* ── Ссылки ── */
.vv-root a { color: var(--vv-link, #4f46e5); text-decoration: none; transition: color 100ms ease; }
.vv-root a:hover { color: var(--vv-link-hover, #4338ca); }
...
.vv-quote {
    margin: 8px 0;
    padding: 4px 12px;
    border-left: 3px solid var(--vv-quote, #4f46e5);
    background: var(--vv-quote-bg, rgba(226, 228, 237, 0.03));
...
.vv-code {
    display: block;
    background: var(--vv-code-bg, #1b1f2a);
    padding: 16px;
    border-radius: 8px;
    margin: 12px 0;
    font-family: "Courier New", Courier, monospace;
    ...
    overflow-x: auto;
    color: var(--vv-text, #e2e4ed);
    border: 1px solid var(--vv-code-border, #2a2d3e);
}
